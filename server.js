            ...
            bcrypt.genSalt(10,function(err, Salt){
                bcrypt.hash(password, Salt, function(err,hash){
                    ...
                    const token = jwt.sign({ 
                     ...
                     let content = '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Email Verification</title></head><body><div style="font-family: Arial, sans-serif; padding: 20px; border: 1px solid #e0e0e0; max-width: 500px; margin: 20px auto;"><h2>Hello '+fname+'!</h2><p>Thank you for signing up. To continue, please verify your email address by clicking the button below:</p><a href="https://eventecho.onrender.com/verify/'+token+'"style="display: inline-block; padding: 10px 20px; background-color: #007bff; color: #ffffff; text-decoration: none; border-radius: 5px; margin-top: 20px;">Verify Email</a><p>If the above button does not work, you can also click on the link below:</p><p><a href="https://eventecho.onrender.com/verify/'+token+'">Click here to verify your email</a></p><p>This Verification Link will expire in 10 minutes.</p></div></body></html>';
